...
def test_crypto_generate_keypair():
    ...
    from aip_cli.crypto import generate_keypair, compute_kid
...
def test_crypto_sign_and_verify():
    ...
    from aip_cli.crypto import generate_keypair, sign_token_request, compute_kid
...
def test_config_paths():
    ...
    from aip_cli.config import AIP_HOME, get_config_path, get_agent_dir
